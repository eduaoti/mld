...
class ActividadesController {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.pool.query('UPDATE actividades set ?  WHERE idActividad = ?', [req.body, id]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.pool.query('UPDATE actividades set Estatus = "CANCELADA" WHERE idActividad = ?', [id]);
